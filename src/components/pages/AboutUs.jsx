...
const AboutUs = forwardRef((props, ref) => {
  ...
  return (
    ...
    >
      ...
      <div className="about-content-inner bg-background w-full items-center pt-2 text-center flex-1 h-full z-10 md:h-auto md:overflow-visible md:justify-center md:py-8">
        <Container>
          {/* Subtitle */}
          ...
          {/* Social Icons */}
          <div className="flex items-center gap-2 md:gap-6 md:mt-8 justify-center">
